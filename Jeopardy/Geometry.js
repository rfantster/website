...
function mini(){
    ...
    <link rel="canonical" href="/play/geometry152" />
    <script>
        var modal = function(){}
        ...
        function getOldState(){
            try {
                var old_state = localStorage.getItem("game-140037")
            } catch (e) {
                return null;
        ...
        function clearState(){
            try {
                localStorage.removeItem("game-140037");
            } catch (e) {
        ...
        ready(function(){
            ...
            var debouncedSaveState = debounce(function(){
                try {
                    localStorage.setItem("game-140037", JSON.stringify(getCurrentState()))
                } catch (e) {
    ...
    function clearLocalStorage(){
        for(var i = localStorage.length-1; i >= 0 ; i--){
            ...
            //(key.indexOf("jeopardy-0-") == 0 && localStorage.getItem("jeopardy-0") == "140037")){
            if(key.indexOf("jeopardy-140037") == 0){
